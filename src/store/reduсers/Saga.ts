...
import { postsFetching, postsFetchingSuccess, postsFetchingError } from './PostSlice';

function* getPostsWorker() {
  try {
    const { data }: AxiosResponse = yield call(axios.get, 'https://jsonplaceholder.typicode.com/posts');
